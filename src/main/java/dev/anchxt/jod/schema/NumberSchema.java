...
/**
 * Abstract base class for numeric schema validation.
 * Provides common constraints: min, max, positive, multipleOf.
 *
...
public abstract class NumberSchema<T extends Number & Comparable<T>, S extends NumberSchema<T, S>>
    ...
    /**
     * Check if value is a multiple of divisor. Subclasses override for
     * type-specific modulo.
     */
